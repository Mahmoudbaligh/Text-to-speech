...
play_button = tk.Button(button_frame, text="Play", command=play_text, width=10, bg="light green")
play_button.grid(row=0, column=0, padx=5)

reset_button = tk.Button(button_frame, text="Reset", command=reset_text, width=10, bg="light blue")
